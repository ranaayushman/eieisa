                    ...
                    <div
                        ...
                        <div className='md:w-1/2'>
                            ...
                            <p className="text-lg md:text-xl mb-8">
                                ...
                                The International Society of Automation (ISA) chapter at Haldia Institute of Technology (HIT) is a
                                student-run organization affiliated with the global ISA network. It provides students with opportunities to learn about
                                automation and control systems, participate in workshops and seminars, and connect with professionals in the field. The chapter aims
                                to bridge the gap between academic knowledge and industry practices, offering members access to resources,
                                certifications, and networking events that can enhance their careers in automation and related fields. </p>
                        </div>
                    </div>
                </div>
            </MaxWidthWrapper>
